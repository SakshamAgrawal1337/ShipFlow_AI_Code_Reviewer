...
export async function redirectToSignIn(request: NextRequest, pathname: string) {
    const signInUrl = new URL(SIGN_IN_PATH, request.url);
    //Include the callbackUrl in the query parameters to redirect back after sign-in
...
// "/" is always public 
//"/sign-in": logged in uswer should be redirected away
